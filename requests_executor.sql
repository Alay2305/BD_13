...
CREATE TABLE `executor` (
  `executor_id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `executor` VALUES (1,'Петров Петр Петрович'),(2,'Сидоров Алексей Викторович'),(3,'Васильев Николай Александрович'),(4,' Федоров Дмитрий Сергеевич'),(5,'Кузнецов Алексей Владимирович');
